...
<head>
	...
	<link rel="stylesheet" type="text/css" href="tourism_admin.css">
	      ...
	      <ul class="list">
	        ...
	        <div class="search">
	            <form method="POST" action="info.php">
	              ...
	              <input type="image" name="submit_p" src="https://img.icons8.com/?size=100&id=W0xu6u7K9A0F&format=png&color=000000" width="22px" height="22px" alt="Search image" style="margin-left: 35px;">
	            </form>
	        </div>
	      </ul>
	      <ul class="list2">
	...
	<div class="container">
		...
		<div class="agent-workspace work" id="id2">
			...
			<div class="delete-form" id="del-form2">
				<form method="POST" action="tourism_admin_op.php">     
					<input type="text" name="aid" placeholder="Agent ID" required><br>
					<input type="text" name="afname" placeholder="First name" required><br>
