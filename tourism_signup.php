<?php
$con=mysqli_connect('localhost','root','travel','yamuna');
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="tourism_signup.css">
</head>
...
<div class="main">
    <ul>
      ...
      <ul class="list2">
        ...
        <li class="active-menu"><a href="tourism_signup.html">Sign Up</a></li>
        <li><a href="tourism_feedback.html">Feedback</a></li>
      </ul>
    </ul>
</div>

  <form from="myForm" action ="tourism_save.php" method="POST">
    ...
    <div class="login-box">
      ...
      <center> <a href="tourism_signin_index.html"> Already have an account ? </a> <center>
